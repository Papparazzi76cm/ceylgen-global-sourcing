...
export const products: Product[] = [
  {
    ...
    specs: [
      { parameter: "Iodine Number", qualifier: "min.", value: "1100", unit: "mg/g" },
      { parameter: "CTC Adsorption", qualifier: "min.", value: "55", unit: "% w/w" },
      { parameter: "Apparent Density, dry", qualifier: "min.", value: "0.48", unit: "g/cc" },
      { parameter: "Moisture as packed", qualifier: "max.", value: "5", unit: "%" },
      { parameter: "Total Ash", qualifier: "max.", value: "3", unit: "%" },
      { parameter: "Extractable pH", value: "9 – 11" },
      { parameter: "Hardness Number", qualifier: "min.", value: "98", unit: "%" },
      { parameter: "Particle Size", value: "12 × 30 ASTM mesh" },
      { parameter: "> 12 mesh (1.700 mm)", qualifier: "max.", value: "5", unit: "%" },
      { parameter: "12 × 30 mesh (1.700 × 0.600 mm)", qualifier: "min.", value: "90", unit: "%" },
      { parameter: "< 30 mesh (0.600 mm)", qualifier: "max.", value: "5", unit: "%" },
    ],
    i18n: {
      es: {
