-- Fase 6: endurecimiento del formulario público de contacto.
-- El cliente deja de insertar directamente en public.leads y utiliza una función
-- con una superficie de entrada limitada y validación centralizada.
...
REVOKE ALL ON FUNCTION public.submit_public_lead(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, JSONB) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.submit_public_lead(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, JSONB) TO anon, authenticated;

-- Impide que clientes públicos eludan la función insertando directamente.
REVOKE INSERT ON public.leads FROM anon;
DROP POLICY IF EXISTS "leads_public_insert" ON public.leads;

COMMENT ON FUNCTION public.submit_public_lead(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, JSONB)
IS 'Valida, normaliza y registra solicitudes públicas del formulario de contacto.';
